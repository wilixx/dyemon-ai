/**This class defines a new datatype for the whole units in the neural networks.
 * Note that the whole framework of this is based on a thinking of operation with both forward and backward directions.
 * 
 * class name: dyemon
 * params:value,grad
 * 
...
console.log(a_grad+"+"+ b_grad+"+"+c_grad+"+"+x_grad+"+"+y_grad); // prints 0.8825